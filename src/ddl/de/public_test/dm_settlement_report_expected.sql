...
(
    id                       integer generated always as identity
        constraint dm_settlement_report_pkey_expected
            primary key,
    ...
    constraint dm_settlement_report_restaurant_id_settlement_year_settleme_ex
        unique (restaurant_id, settlement_year, settlement_month)
);

alter table public_test.dm_settlement_report_expected
    owner to jovyan;
